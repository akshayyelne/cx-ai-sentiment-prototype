...
def detect_intent(question):
    ...
    driver_keywords = ["driver", "cause", "reason", "why", "root", "What is driving"]
    risk_keywords = [
        "risk", "forecast", "predict", "trend",
        "future", "impact", "decline", "exposure",
        "consequence", "next", "what happens if",
        "if we do nothing"
    ]
    action_keywords = [
        "action", "recommend", "improve",
        "priority", "prioritise", "prioritize",
        "what should we", "what should leadership",
        "stabilise", "stabilize", "mitigate",
        "fix", "address", "focus on"
    ]
...
Please specify which area you'd like to explore."""
...
Please tell me which area you'd like to explore."""
        }
    ]
